...
console.log(longestPalindrome("baccabac"));
console.log(longestPalindrome("bababd"));
console.log("bbbbb", longestPalindrome("bbbbb"));
console.log("cbbbbbd", longestPalindrome("cbbbbbd"));
console.log("bb", longestPalindrome("bb"));
